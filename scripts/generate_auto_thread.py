...
def build_prompt(
    ...
    return (
        ...
        "- Replies should add practical depth.\n"
        "- Reply 2 should include at least one copyable prompt, checklist, criteria, workflow mode, or failure-prevention rule when possible.\n"
        "- Reply 3 may include source repo/docs/blog links and how to apply them.\n"
        "- Do not force every post into the '만약 [나쁜 사용]' template. Use the selected format naturally.\n"
